    ...
    for (auto it = operations.begin(); it != operations.end(); ++it) {
        ...
        switch (operation->type()) {
            ...
            case OperationType::BIDIRECTIONAL_SEQUENCE_LSTM: {
                ...
                mark_operand_float_to_half(operation->input(18));
                mark_operand_float_to_half(operation->input(19));
                mark_operand_float_to_half(operation->input(20));
                mark_operand_float_to_half(operation->input(21));
                mark_operand_float_to_half(operation->input(22));
                mark_operand_float_to_half(operation->input(23));
                mark_operand_float_to_half(operation->input(24));
                mark_operand_float_to_half(operation->input(25));
                mark_operand_float_to_half(operation->input(26));
                mark_operand_float_to_half(operation->input(27));
                mark_operand_float_to_half(operation->input(28));
                mark_operand_float_to_half(operation->input(33));
                mark_operand_float_to_half(operation->input(35));
                mark_operand_float_to_half(operation->input(36));
                mark_operand_float_to_half(operation->input(37));
                mark_operand_float_to_half(operation->input(38));
                mark_operand_float_to_half(operation->input(39));
                mark_operand_float_to_half(operation->input(40));
                mark_operand_float_to_half(operation->input(41));
                mark_operand_float_to_half(operation->input(42));
                mark_operand_float_to_half(operation->input(43));
                mark_operand_float_to_half(operation->input(44));
                mark_operand_float_to_half(operation->input(45));
                mark_operand_float_to_half(operation->input(46));
                mark_operand_float_to_half(operation->input(47));
                mark_operand_float_to_half(operation->input(53));
                mark_operand_float_to_half(operation->input(54));
                mark_operand_float_to_half(operation->input(55));
                mark_operand_float_to_half(operation->input(56));
                mark_operand_float_to_half(operation->input(57));
                mark_operand_float_to_half(operation->input(58));
                mark_operand_float_to_half(operation->input(59));
                mark_operand_float_to_half(operation->input(60));
                mark_operand_float_to_half(operation->output(0));
                mark_operand_float_to_half(operation->output(1));
            } break;
