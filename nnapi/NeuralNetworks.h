 ...
 */
EXPORT void ANeuralNetworksMemory_free(ANeuralNetworksMemory* memory);
 ...
 */
EXPORT int ANeuralNetworksModel_create(ANeuralNetworksModel** model);
 ...
 */
EXPORT void ANeuralNetworksModel_free(ANeuralNetworksModel* model);
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
EXPORT int ANeuralNetworksModel_finish(ANeuralNetworksModel* model);
 ...
 *                    results in no operation.
 */
EXPORT void ANeuralNetworksCompilation_free(ANeuralNetworksCompilation* compilation);
 ...
 * @return ANEURALNETWORKS_NO_ERROR if successful.
 */
EXPORT int ANeuralNetworksCompilation_finish(ANeuralNetworksCompilation* compilation);
 ...
 *                  results in no operation.
 */
EXPORT void ANeuralNetworksExecution_free(ANeuralNetworksExecution* execution);
 ...
 */
EXPORT int ANeuralNetworksEvent_wait(ANeuralNetworksEvent* event);
 ...
 * Available since API level 27.
 */
EXPORT void ANeuralNetworksEvent_free(ANeuralNetworksEvent* event);
